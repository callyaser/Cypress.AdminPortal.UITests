import { SecurityRolesPage } from "../pageObjects/security-roles-page";
import { Webpage } from "./Webpage";

export class SecurityRolesCreatePage extends Webpage {
    ...
    public merchantsModule = 'div.flex-1.ng-star-inserted';
    public moduleCheckbox: string = '[data-testing="gridRowCheckboxInput"]';
    public selectAllModulesRadioBtn = '//span[text()="Select all modules"]/following-sibling::div/input';
    public modulesDropdown = '.k-expander-title.ng-star-inserted';
    public selectAllMerchantsBtn = '[formcontrolname="isAllMerchantsAllowed"]>label>div>input';
    public visibleRadioBtn = 'label[class="flex items-center"]>div>input';
    public selectAllAffiliateGroupsBtn='[formcontrolname="isAllAffiliateGroupsAllowed"]>label>div>input';
    public selectAllAffiliateOtherRule='[formcontrolname="isAllAffiliateGroupsAllowed"]';
    public dialogWindow = 'div[role="dialog"]';
